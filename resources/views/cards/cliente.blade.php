                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="cliente_nome" type="text" maxlength="14" class="form-control  @error('cliente_nome') is-invalid @enderror" placeholder="Digite o nome do Requerente" value="{{old('cliente_nome')}}" name="cliente_nome">
                                @error('cliente_nome')
